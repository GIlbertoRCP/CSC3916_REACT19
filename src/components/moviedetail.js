  ...
  const DetailInfo = () => {
    ...
    return (
      <Card className="bg-dark text-dark p-4 rounded">
        ...
        <Image 
    className="image" 
    src={selectedMovie.imageUrl ? selectedMovie.imageUrl : "https://placehold.co/300x450/212529/FFF?text=No+Poster"} 
    thumbnail 
...
/>
        ...
        <ListGroup>
          ...
          <ListGroupItem>
            <h5>Actors:</h5>
            {/* Safe mapping just in case actors array is missing */}
        ...
        <Card.Body className="card-body bg-light mt-3 rounded">
          ...
          {/* ADDED: The Review Submission Form */}
